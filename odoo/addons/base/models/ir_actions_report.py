...
try:
    ...
    if match:
        ...
        if config['workers'] == 1:
            _logger.info('You need to start Strada with at least two workers to print a pdf version of the reports.')
    ...
    def _merge_pdfs(self, streams):
        ...
        for stream in streams:
            try:
                ...
                raise UserError(_("Strada is unable to merge the generated PDFs."))
